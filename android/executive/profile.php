...
$msg = "";
  ...
  // withdrawal amount
  $query2="SELECT * FROM `withdrawal` WHERE `user_id`='$ids' AND `type` = 'field_executive'";
                ...
                <table class="table">
                    <thead>
                        <tr>
                            <th>Wallet:</th>
                            <?php if(!empty($data1)){ ?>
                         <td>&#8377;<?php echo ($data1['amount']-$data2['amount']); ?>&nbsp;&nbsp;&nbsp;<button class="btn btn-sm btn-success withdrawl" data-toggle="modal" 
