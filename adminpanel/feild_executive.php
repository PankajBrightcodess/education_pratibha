              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="department-list">
                     <div class="card">
              <div class="card-header">
                <h5 style="font-weight: bold;">Field Executive List</h5>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                        ...
                        if(!empty($executive)){ $sn=0;
                          foreach ($executive as $key => $value) {$sn++;
                            ...
                            <tr>
                              ...
                              <td> <button class="btn btn-sm btn-success editexecutive" data-toggle="modal" data-id="<?php echo $value['id']; ?>" data-name="<?php echo $value['name']; ?>" data-gender="<?php echo $value['gender']; ?>" data-dob="<?php echo $value['dob']; ?>" data-mobile="<?php echo $value['mobile']; ?>" data-email="<?php echo $value['email']; ?>" data-location="<?php echo $value['location']; ?>" data-city="<?php echo $value['city']; ?>" data-state="<?php echo $value['state']; ?>" data-pincode="<?php echo $value['pincode']; ?>" data-password="<?php echo $value['password']; ?>" data-target="#departmentModal">&nbsp;&nbsp;<i class="far fa-edit nav-icon"></i>&nbsp;Edit</button><button class="btn btn-sm btn-success" >Student view</button></td>
                           </tr>
                          <?php
                          }
                        }
