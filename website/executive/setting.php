...
<style type="text/css">
 ...
 <!-- <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"> -->
    ...
    <section style="background:#182458;margin-top: -9px; padding-top: 12px;">
    ...
    <section style="padding-top:30px;padding-bottom: 11px;">
      <div class="container">
        <h5 class="text-center" style="color:#ec870f">Change Password</h5>
        <div class="row justify-content-center">
          <form method="POST" action="">
            ...
            <div class="col-12 col-md-12">
             ...
             <!--   <a href="" type="submit" name="setting_change_password" class="setting_password"><img src="../../images/submit.jpg" width="100%"></a> -->
               <button type="button" name="setting_change_password" class="setting_password btn btn-block" style="border:none; background:#06bebe"><img src="../../images/submit.jpg" width="100%" height="90px"> </button>
            </div>
          </form>
        </div>
      </div>
